...
require(["main-gsap", "jquery-1.11.0.min", "neon-demo", "neon-custom",
    "bootstrap", "joinable", "resizeable", "neon-api", "neon-register",
    "neon-login", "jquery.validate.min", "jquery.inputmask.bundle.min",
    "jquery-ui-1.10.3.minimal.min"], function (bootstrap)
{
